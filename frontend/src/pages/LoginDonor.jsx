  ...
  const loginUser = async () => {
    try {
      ...
      const endpoint = (() => {
        switch (role) {
          case "donor":
            return `${API_BASE_URL}/api/auth/login-donor`;
          case "hospital":
            return `${API_BASE_URL}/api/auth/login-hospital`;
          case "bloodBank":
            return `${API_BASE_URL}/api/auth/login-bloodBank`;
          case "authority":
            return `${API_BASE_URL}/api/auth/login-authority`;
          case "patient":
            return `${API_BASE_URL}/api/auth/login-patient`;
          default:
      ...
      const storageKey = `${role}`; // Key to store data for each role
